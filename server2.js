...
window.axios.post('/send', buildData).then(console.log).catch(console.log)
  req.on("end", function () {
    debugger
    fs
  });
...
app.post("/api/payment", function (req, res) {
  var pay;
  pay.key = '7rnFly';
  pay.surl = "http://localhost:4200/success";
  pay.furl = "http://localhost:4200/failed";
  request.post(
    {
      headers: {
...
app.post("/api/failed", function (req, res) {
  debugger
})
/*
